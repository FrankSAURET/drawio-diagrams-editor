# À faire
1. ⬜ Vérifier en vrai le lot v2026.8.0.9 sur le VSIX reconstruit : Ctrl+S en une fois, coller un SVG, les quatre menus rétablis, Ctrl+C en SVG, numéro de version affiché.
